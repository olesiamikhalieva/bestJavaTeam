...
public class ForExcel {
    ...
    public static void main(String[] args) throws IOException {
        readFromExcel("c:\\Users\\Dron\\Desktop\\TyresSumy.xls");
    }
    ...
    public static void readFromExcel(String file) throws IOException {
        ...
        if (rowH.getCell(0).getCellType() == HSSFCell.CELL_TYPE_NUMERIC) {
            System.out.print(rowH.getCell(0).getStringCellValue() + "\t\t\t");
        }
        ...
        while (rows.hasNext()) {
            ...
            HSSFCell shCel0 = row.getCell(0); //ФИО
            ...
            if (shCel0 != null) {
                System.out.print(shCel0.getNumericCellValue() + "\t\t");
            }
            if (shCell != null) {
