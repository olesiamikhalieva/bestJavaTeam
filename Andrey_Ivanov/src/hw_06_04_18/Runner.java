...
import java.util.HashMap;
       /*Написать программу, которая берет информацию из нескольких источников( а именно существующего файла с набором произвольной информации
        и из веба, использовать любую ссылку).  Далее эта программа должна записывать информацию следующим образом :
